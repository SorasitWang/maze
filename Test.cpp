...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glBindVertexArray(planeVAO);
        glDrawArrays(GL_TRIANGLES, 0, 6);
        box.draw(shader,lightPos, lightSpaceMatrix,projection,view,camera.Position);
        wall.draw(shader, lightPos, lightSpaceMatrix, projection, view, camera.Position);
